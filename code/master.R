coastal_regions <- read.csv(paste(parent_direct,"data/Coastal regions.csv",sep=""))
...
faf <- faf[!faf$dms_orig %in% c("11-Washington DC", "02-Alaska", "15-Hawaii"),]
faf <- faf[!faf$dms_dest %in% c("11-Washington DC", "02-Alaska", "15-Hawaii"),]
